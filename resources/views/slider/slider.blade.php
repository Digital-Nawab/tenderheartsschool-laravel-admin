                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12">
                                                        <div class="form-group mb-2">
                                                            <img id="category_image_preview" src="{{ old('slider_image') ?? asset('assets/images/logo.png') }}"
                                                                 alt="Slider Image Preview"
                                                                 style="max-width: 60%; margin-top: 10px;" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12">
                                                        <div class="form-group mb-2">
                                                            <img id="category_banner_preview" src="{{ old('mobile_image') ?? asset('assets/images/logo.png') }}"
