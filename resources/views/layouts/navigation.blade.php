...
{{--
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        <!-- item-->
                        <h6 class="dropdown-header">Welcome THS!</h6>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/career-list')}}" role="button"
                        aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-calendar-2-line"></i> <span data-key="t-apps">Career</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/add-news')}}" role="button"
                       aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-rss-line"></i> <span data-key="t-apps">News</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/add-notice')}}" role="button"
                       aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-notification-line"></i> <span data-key="t-apps">Notice </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/add-result')}}" role="button"
                       aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-vip-line"></i> <span data-key="t-apps">Result </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/add-tc-certificate')}}" role="button"
                       aria-expanded="false" aria-controls="sidebarApps">
                        <i class="ri-copyright-line"></i> <span data-key="t-apps">Transfer Certificate </span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{url('/all-branch')}}">
                        <i class="ri-store-2-line"></i> <span data-key="t-layouts">Branch</span>
                    </a>
                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{url('/add-gallery-category')}}">
                ...
                {{--<li>
                    ...
                    <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{url('/add-gallery')}}" class="nav-link">Gallery Category</a>
                            </li>
