                ...
                <div class="col-12">
                    ...
                    <div id="example-form">
                        <section>
                            ...
                            <form method="post" action="{{ url('/add-result') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row ">
                                    <div class="col-md-12">
                                        <div class="row gutters">
                                            <div class="card">
                                                ...
                                                <div class="card-body row">
                                                    ...
                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                                        <div class="form-group mb-2">
                                                            <label for="Slider_image">Result Image 408*510px
                                                                Max=500KB</label><br>
                                                    ...
                                                    <div class="col-xl-1 col-lg-1 col-md-1 col-sm-1 col-12">
                                                        <div class="form-group mb-2">
                                                            <img id="category_image_preview" src="{{ old('image') ?? asset('assets/images/logo.png') }}"
                                                                 alt=" Image Preview"
                ...
                $(document).on('click', ".confirmDelete", function() {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            window.location.href = "/delete-result/" + id;
                        }
                    });
                });
            </script>
